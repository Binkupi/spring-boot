												...
												<c:forEach var="bill" items="${billLists}">
													<tr>
														...
														<c:if test='${ bill.description=="Da xac nhan"}'>
															<td><span class="badge badge--custom badge-primary">Đã xác nhận</span></td>	
														</c:if>
														<c:if test='${ bill.description=="Dang xu ly"}'>
															<td><span class="badge badge--custom badge-warning">Đang xử lý</span></td>	
														</c:if>
														<c:if test='${ bill.description=="Dang giao hang"}'>
															<td><span class="badge badge--custom badge-info">Đang giao hàng</span></td>	
														</c:if>
														<c:if test='${ bill.description=="Da giao hang thanh cong"}'>
															<td><span class="badge badge--custom badge-success">Đã giao hàng thành công</span></td>	
														</c:if>
														<c:if test='${ bill.description=="Da huy"}'>
															<td><span class="badge badge--custom badge-danger">Đã hủy</span></td>	
														</c:if>
														...
														<td><a href="${pageContext.request.contextPath}/admin/bill/${ bill.id }" type="button" class="btn btn-light"><span><i class="fas fa-eye"></i></span> Xem</a>
															<a href="${pageContext.request.contextPath}/admin/bill/update/${ bill.id }" type="button" class="btn btn-info"><span><i class="far fa-edit"></i></span> Sửa</a>
															...
															<p style="display:none" class="id-bill">Mã số bill ${bill.id }</p>
															<button type="button" class="btn btn-danger btn-delele-bill" ><span><i class="fas fa-trash-alt"></i></span> Xóa</button>
