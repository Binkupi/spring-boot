						...
						<div class="col-lg-12 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									...
									<c:forEach var="watch" items="${billDetails}">
										<form:form class="forms-sample" method="POST"
											action="${pageContext.request.contextPath}/admin/bill-detail/update/${watch.id_bill }" modelAttribute="billDetail">
											
												<div class="form-group">
													<label for="exampleInputName1">Mã hóa đơn: ${watch.id_bill } </label>													
												</div>												
												<div class="form-group">
													<label for="exampleInputName1">Số lượng</label>
													<form:input type="text" autocomplete="off"
														class="form-control" path="amount" value="${watch.amount}" />
												</div>
												<div class="form-group">
													<label for="exampleInputName1">Tổng cộng</label>
													<form:input type="text" autocomplete="off"
														class="form-control" path="total_price" value="${watch.total_price}" />
												</div>																																	
