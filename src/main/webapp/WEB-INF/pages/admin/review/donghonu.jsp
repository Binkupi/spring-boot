...
<head>
    ...
    <title>Đồng hồ nữ</title>
        ...
        <link href="css/DH-Nu.css" rel="stylesheet" type="text/css">
...
<body >
   <header>
        <nav>
            ...
            <a class="NavElement" href="News.html">
                <p>Tin tức</p>
            </a>
                ...
                <div id="Div-BoChon" >
                    <div id="BoChon-Row1">
                        <div id="BoChon-Col1" align="center">
                            <table align="center">
                                <tr >
                                    <td colspan="2" align="center"class="title-BoChon">Bộ sưu tập cho Phụ Nữ</td>
                                 </tr>
                                <tr>
                        ...
                        <div id="BoChon-Col4" align="center">
                            <table cellspacing="20px"align="center">
                                ...
                                <tr>
                                    <td align="center" id="Day1"><div class="div-img-day"><img src="images/DH_Nam/day1.png" class="img-day"></div>
				            		...
				            		<c:if test="${watch.sale==0}">
						                <div class="col-sm-3">
						                    <div class="Normal-Product" id="sanPham${watch.id}" align='center'>
						                        <a href="#" class="mask">
						                            <img class="img-responsive zoom-img" src=${watch.img} alt=${watch.name} />
						                        </a>
					                ...
					                <c:if test="${watch.sale!=0}">
					                	<div class="col-sm-3">
						                    <div class="Sale-Product" id="sanPham${watch.id}" align='center'>
						                        <a href="#" class="mask">
						                            <img class="img-responsive zoom-img" src=${watch.img} alt="${wath.name}" />
						                        </a>
						                        <div class="product-bottom">
						                            <h3>${watch.name }</h3>
						                            <p>Khám phá ngay</p>
