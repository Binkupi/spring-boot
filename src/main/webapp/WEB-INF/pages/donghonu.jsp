...
<head>
    ...
    <title>Đồng hồ nữ</title>
        ...
        <link href="${pageContext.request.contextPath}/css/DH-Nu.css" rel="stylesheet" type="text/css">
...
<body >
   <header>
        <nav>
            ...
            <div class="NavElement">
				...
				<div class="dropdown-content">
					...
					<a href="${pageContext.request.contextPath}/donghonu" id="MainNavElement">Đồng hồ nữ</a>
				</div>
			</div>
        ...
        <form id="SearchContent" action="${pageContext.request.contextPath}/donghonu/search" method="GET" 	>
            <div>
        ...
        <div id="BannerDH_Nu">
            <div id="BannerContent">
                <h1>Đồng hồ nữ</h1>
                <h2>Ai bảo con gái không được cá tính</h2>
                <a id="ShoppingButton" href="${pageContext.request.contextPath}/donghonu">Khám phá ngay</a>
            </div>
        </div>
    </header>
                ...
                <div id="Div-BoChon" >
                    <div id="BoChon-Row1">
                        <div id="BoChon-Col1" align="center">
                            <table align="center">
                                <tr >
                                    <td colspan="2" align="center" class="title-BoChon">Bộ lọc cho phụ nữ</td>
                                 </tr>
                                <tr>
