...
<body >
    ...
    <header>
        <nav>
            <a id="Logo" href="${pageContext.request.contextPath}/"><img src="${pageContext.request.contextPath}/Image/Header/Logo.svg" alt="LogoWatchKingdom"></a>
            <a class="NavElement" href="${pageContext.request.contextPath}/blog" id="MainNavElement">
                <p>Tin tức</p>
            </a>
    ...
    <div class="container-fluid mt-5" style="padding-left: 100px; padding-right:100px;" >
        <div class="row">
            <div class="col-lg-8" style="position: relative;">
                <a href="./blog/thay-pin-dong-ho-deo-tay-o-dau">
                    <div class="TrendNews">
                    ...
                    <img src="${pageContext.request.contextPath}/images/News/thay-pin-dong-ho-watchkingdom.jpg" class="Img-Trending-New" alt="watchkingdom thay pin đồng hồ đeo tay uy tín tại thành phố Hồ Chí Minh">
                </a>                   
            </div>
            <div class="col-lg-4" style="position: relative;">
                <a href="${pageContext.request.contextPath}/blog/7-luu-y-quan-trong-khi-chon-mua-dong-ho">
                    <div  class="TrendNews" >
                        <h4>7 lưu ý quan trọng khi chọn mua đồng hồ</h4>
                        <span><i class="fas fa-comment-alt"></i> Bình Luận</span>  <span class="Time">33 phút trước</span>
                    </div>   
                    <img src="${pageContext.request.contextPath}/images/News/luu-y-khi-mua-dong-ho-watchkingdom.jpg" class="Img-Trending-New" alt="watchkingdom lưu những lưu ý khi mua đồng hồ">
                </a>    
        ...
        <div class="row mt-5">
            <div class="col-lg-8">
                ...
                <div class="row mt-3">
                    <div class="col-lg-5 align-self-center">
                        <a href="${pageContext.request.contextPath}/blog/thay-pin-dong-ho-deo-tay-o-dau"><img src="${pageContext.request.contextPath}/images/News/thay-pin-dong-ho-watchkingdom.jpg" alt="watchkingdom thay pin đồng hồ đeo tay uy tín tại thành phố Hồ Chí Minh" class="Img-News"/></a>
                    </div>
                    <div class="col-lg-7">
                        <a href="${pageContext.request.contextPath}/blog/thay-pin-dong-ho-deo-tay-o-dau" class="PageNews"><h3>Thay Pin Đồng Hồ Đeo Tay Ở Đâu Uy Tín Tại TPHCM</h3></a>
                ...
                <div class="row mt-3">
                    <div class="col-lg-5 align-self-center">
                        <a href="./blog/kien-thuc-can-thiet-de-bao-quan-dong-ho-deo-tay-tot-nhat"><img src="${pageContext.request.contextPath}/images/News/kien-thuc-bao-quan-dong-ho-watchkingdom.jpg" alt="watckingdom kiến thức để bảo quản đồng hồ đeo tay tốt nhất" class="Img-News"/></a>
                    </div>
                    <div class="col-lg-7">
                        <a href="./blog/kien-thuc-can-thiet-de-bao-quan-dong-ho-deo-tay-tot-nhat" class="PageNews"><h3>Kiến thức cần thiết để bảo quản đồng hồ đeo tay tốt nhất</h3></a>
                        <h6>Đăng tải ngày 3/3/2021</h6>
                ...
                <div class="row mt-3">
                    <div class="col-lg-5 align-self-center">
                        <a href="${pageContext.request.contextPath}/blog/top-dong-ho-nam-nu-ban-chay-nhat-gia-chua-den-5-trieu-dong"><img src="${pageContext.request.contextPath}/images/News/dong-ho-cap-nam-nu-watchkingdom.png" alt="watchkingdom đồng hồ nam nữ đeo tay giá dưới 5 triệu"  class="Img-News"/></a>
                    </div>
                    <div class="col-lg-7">
                        <a href="${pageContext.request.contextPath}/blog/top-dong-ho-nam-nu-ban-chay-nhat-gia-chua-den-5-trieu-dong" class="PageNews"><h3>Bộ sưu tập đồng hồ nam, nữ bán chạy nhất dưới 5 triệu đồng</h3></a>
                        <h6>Đăng tải ngày 3/3/2021</h6>
                ...
                <div class="row mt-3">
                    <div class="col-lg-5 align-self-center">
                        <a href="${pageContext.request.contextPath}/blog/top-15-thuong-hieu-dong-ho"><img src="${pageContext.request.contextPath}/images/News/thuong-hieu-dong-ho-thoi-trang-watchkingdom.jpg" alt="15 thương hiệu đồng hồ thời trang nam nữ đáng mua" class="Img-News"/></a>
                    </div>
                    <div class="col-lg-7">
                        <a href="${pageContext.request.contextPath}/blog/top-15-thuong-hieu-dong-ho" class="PageNews"><h3>Danh sách 15 thương hiệu đồng hồ thời trang nam, nữ đáng mua</h3></a>
                        <h6>Đăng tải ngày 3/3/2021</h6>
            ...
            <div class="col-lg-4">
                ...
                <div class="row mb-2">
                    <div class="col-4">
                        <a href="${pageContext.request.contextPath}/blog/7-luu-y-quan-trong-khi-chon-mua-dong-ho"><img src="${pageContext.request.contextPath}/images/News/luu-y-khi-mua-dong-ho-watchkingdom.jpg" alt="7 lưu ý quan trọng khi chọn mua đồng hồ watchkingdom"  class="Img-Trending"/></a>
                    </div>
                    <div class="col-8">
                        <a href="${pageContext.request.contextPath}/blog/7-luu-y-quan-trong-khi-chon-mua-dong-ho" class="PageNews"><h6>7 lưu ý quan trọng khi chọn mua đồng hồ</h6></a>
                        <span><i class="fas fa-comment-alt"></i> Bình Luận</span>  <span class="Time">33 phút trước</span>
                    </div>
                </div>
                <hr>
                <div class="row mb-2">
                    <div class="col-4">
                        <a href="${pageContext.request.contextPath}/blog/top-10-cua-hang-ban-dong-ho-chinh-hang-uy-tin-nhat-tphcm"><img src="${pageContext.request.contextPath}/images/News/top-10-cua-hang-ban-dong-ho-chinh-hang-watch-kingdom.png" alt="top 10 cửa hàng bán đồng hồ chính hãng tại thành phố Hồ Chí Minh" class="Img-Trending" /></a>
                    </div>
                    <div class="col-8">
                        <a href="${pageContext.request.contextPath}/blog/top-10-cua-hang-ban-dong-ho-chinh-hang-uy-tin-nhat-tphcm" class="PageNews"><h6>Top 10 cửa hàng bán đồng hồ chính hãng uy tín nhất TPHCM</h6></a>
                        <span><i class="fas fa-comment-alt"></i> Bình Luận</span>  <span class="Time">33 phút trước</span>
                    </div>
                </div>
                <hr>
                <div class="row mb-2">
                    <div class="col-4">
                        <a href="${pageContext.request.contextPath}/blog/phan-biet-dong-ho-automatic-theo-chuyen-gia"><img src="${pageContext.request.contextPath}/images/News/phan-biet-dong-ho-watchkingdom.png" alt="phân biệt đồng hồ automatic theo chuyên gia watchkingdom" class="Img-Trending" /></a>
                    </div>
                    <div class="col-8">
                        <a href="${pageContext.request.contextPath}/blog/phan-biet-dong-ho-automatic-theo-chuyen-gia" class="PageNews"><h6>Phân biệt đồng hồ automatic theo cách chuyên gia</h6></a>
                        <span><i class="fas fa-comment-alt"></i> Bình Luận</span>  <span class="Time">33 phút trước</span>
                    </div>
                </div>
                <hr>
                <div class="row mb-2">
                    <div class="col-4">
                        <a href="${pageContext.request.contextPath}/blog/huong-dan-cach-kiem-tra-dong-ho"><img src="${pageContext.request.contextPath}/images/News/huong-dan-kiem-tra-dong-ho-watchkingdom.jpg" alt="hướng dẫn kiểm tra đồng hồ chính hãng đơn giản watchkingdom" class="Img-Trending" /></a>
                    </div>
                    <div class="col-8">
                        <a href="${pageContext.request.contextPath}/blog/huong-dan-cach-kiem-tra-dong-ho" class="PageNews"><h6>Hướng dẫn cách kiểm tra đồng hồ chính hãng đơn giản và chính xác nhất</h6></a>
                        <span><i class="fas fa-comment-alt"></i> Bình Luận</span>  <span class="Time">33 phút trước</span>
                    </div>
                </div>
                <hr>
            ...
            <div class="news__black_link">
                ...
                <p class="news__black_link-text"><em> Ghé thăm cửa hàng WatchKingDom giá rẻ, chất lượng <a href="${pageContext.request.contextPath}" rel="dofollow"><b>Tại đây</b></a></em></p>       
            </div>
    </div>
